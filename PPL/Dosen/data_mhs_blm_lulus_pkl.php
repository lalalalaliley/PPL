...
FROM mahasiswa INNER JOIN pkl ON mahasiswa.NIM = pkl.nim_mhs WHERE pkl.status_pkl = 'Belum Lulus' ORDER BY mahasiswa.angkatan");
?>
...
<body>
    ...
    <section class="p-1 my-container ">
        <div class="container m-p-0">
            ...
            <div class="card ">
                <div class="card-header text-center font-weight-bold">Daftar Mahasiswa Informatika Yang Belum Lulus PKL</div>
                <div class="card-body">
