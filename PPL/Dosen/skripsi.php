...
$result = mysqli_query($koneksi, "SELECT * FROM skripsi");
?>
                    ...
                    <div class="container ">
                        <div class="row">
                            <div class="col">
                                <h1>
                                    <?php
                                    $jumlah = mysqli_query($koneksi, "SELECT * FROM skripsi WHERE status_skripsi='Lulus'");
                                    $jumlah_mahasiswa = mysqli_num_rows($jumlah);
                                    ?>
                                    <a href="data_mhs_lulus_skripsi.php"><?php echo $jumlah_mahasiswa ?></a>
                                </h1>
                                <h2>Lulus Skripsi</h2>

                                <h1>
                                    <?php
                                    $jumlah = mysqli_query($koneksi, "SELECT * FROM skripsi WHERE status_skripsi='Belum Lulus'");
                                    $jumlah_mahasiswa = mysqli_num_rows($jumlah);
                                    ?>
                                    <a href="data_mhs_blm_lulus_skripsi.php"><?php echo $jumlah_mahasiswa ?></a>
                                </h1>
                                <h2>Belum Lulus Skripsi</h2>

                                <h1>
                                    <?php
                                    $jumlah = mysqli_query($koneksi, "SELECT * FROM skripsi WHERE status_skripsi='Belum Skripsi'");
                                    $jumlah_mahasiswa = mysqli_num_rows($jumlah);
                                    ?>
                                    <a href="data_mhs_blm_skripsi.php"><?php echo $jumlah_mahasiswa ?></a>
                                </h1>
                                <h2>Belum Skripsi</h2>
