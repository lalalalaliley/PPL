...
$result = mysqli_query($koneksi, "SELECT * FROM mahasiswa ORDER BY angkatan ASC");
?>
...
<body>
    ...
    <section class="p-1 my-container ">
        <div class="container m-p-0">
            ...
            <center><h2>Rekap Mahasiswa Informatika</h2></center>
            <div class="row">
            <div class="col-lg-1">
                    <div class="container m-p-0">                     
                        <a href="data_mhs_2016.php" class="btn my-1" id="menu-btn">2016</a>
                        <a href="data_mhs_2017.php" class="btn my-1" id="menu-btn">2017</a>
                        <a href="data_mhs_2018.php" class="btn my-1" id="menu-btn">2018</a>
                        <a href="data_mhs_2019.php" class="btn my-1" id="menu-btn">2019</a>
                        <a href="data_mhs_2020.php" class="btn my-1" id="menu-btn">2020</a>
                        <a href="data_mhs_2021.php" class="btn my-1" id="menu-btn">2021</a>
                        <a href="data_mhs_2022.php" class="btn my-1" id="menu-btn">2022</a>
                    </div>
            </div>
            <div class="col-lg-11">
                <div class="card">
