...
$query = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE status_mhs = 'Aktif'");
$jumlah_aktif = mysqli_num_rows($query);
$query2 = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE status_mhs = 'Cuti'");
$jumlah_cuti = mysqli_num_rows($query2);
?>
        ...
        <div class="container m-p-0">
            ...
            <div class="col-lg-4">
                    <div class="container m-p-0"><br>                    
                        <br><center><h5>Total Mahasiswa Aktif</h5></center><br>
                        <center><h1><?php echo $jumlah_aktif ?></h1></center><br>
                        <center><h5>Total Mahasiswa Cuti</h5></center><br>
                        <center><h1><?php echo $jumlah_cuti ?></h1></center>
