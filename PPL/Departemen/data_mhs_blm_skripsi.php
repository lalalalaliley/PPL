...
FROM mahasiswa INNER JOIN skripsi ON mahasiswa.NIM = skripsi.nim_mhs WHERE skripsi.status_skripsi = 'Belum Skripsi' ORDER BY mahasiswa.angkatan");
?>
...
<body>
    ...
    <section class="p-1 my-container ">
        <div class="container m-p-0">
            ...
            <center><h2>Daftar Mahasiswa Informatika Yang Belum Skripsi</h2></center>
            <div class="row">
            <div class="col-lg-1">
            </div>
            <div class="col-lg-11">
