...
$query = mysqli_query($koneksi, "SELECT * FROM skripsi WHERE status_skripsi = 'Lulus'");
$jumlah_lulus = mysqli_num_rows($query);
$query2 = mysqli_query($koneksi, "SELECT * FROM skripsi WHERE status_skripsi = 'Belum Lulus'");
$jumlah_belum_lulus = mysqli_num_rows($query2);
$query3 = mysqli_query($koneksi, "SELECT * FROM skripsi WHERE status_skripsi = 'Belum Skripsi'");
$jumlah_belum_skripsi = mysqli_num_rows($query3);
?>
        ...
        <div class="container m-p-0">
            ...
            <div class="col-lg-4">
                    <div class="container m-p-0"><br>                    
                        <center><h5>Total Mahasiswa Lulus Skripsi</h5></center><br>
                        <center><a href="data_mhs_lulus_skripsi.php"><h1><?php echo $jumlah_lulus ?></h1></a></center><br>
                        <center><h5>Total Mahasiswa Belum Lulus Skripsi</h5></center><br>
                        <center><a href="data_mhs_blm_lulus_skripsi.php"><h1><?php echo $jumlah_belum_lulus ?></h1></a></center><br>
                        <center><h5>Total Mahasiswa Belum Skripsi</h5></center><br>
                        <center><a href="data_mhs_blm_skripsi.php"><h1><?php echo $jumlah_belum_skripsi ?></h1></a></center><br>
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <?php include("chart/index-skripsi.php"); ?>
                    </div>
                </div>
            </div>
            </div>
